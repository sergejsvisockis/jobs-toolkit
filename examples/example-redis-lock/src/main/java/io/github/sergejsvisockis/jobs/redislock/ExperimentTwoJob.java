...
@Component
public class ExperimentTwoJob extends AbstractJob {

    private static final Logger LOG = LoggerFactory.getLogger(ExperimentTwoJob.class);

    public ExperimentTwoJob(JobRepository jobRepository, LockRepository lockRepository) {
    ...
    public void execute() throws JobExecutionException {
        LOG.info("Doing some job TWO");
    }

    @Override
    public String getJobName() {
        return "ExperimentTwoJob";
    }
}
